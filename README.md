...
Client: Sends an order request via REST API (secured with JWT).
API Layer:
...
Messaging Layer: RabbitMQ queues the message, decoupling the user interface from heavy processing.
Background Worker:
